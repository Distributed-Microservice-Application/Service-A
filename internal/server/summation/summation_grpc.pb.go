...
type SummationServiceClient interface {
	CalculateSum(ctx context.Context, in *SummationRequest, opts ...grpc.CallOption) (*SummationResponse, error)
}
...
func (c *summationServiceClient) CalculateSum(ctx context.Context, in *SummationRequest, opts ...grpc.CallOption) (*SummationResponse, error) {
	out := new(SummationResponse)
	err := c.cc.Invoke(ctx, "/summation.SummationService/CalculateSum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SummationServiceServer interface {
	CalculateSum(context.Context, *SummationRequest) (*SummationResponse, error)
...
func (UnimplementedSummationServiceServer) CalculateSum(context.Context, *SummationRequest) (*SummationResponse, error) {
...
func _SummationService_CalculateSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SummationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SummationServiceServer).CalculateSum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/summation.SummationService/CalculateSum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SummationServiceServer).CalculateSum(ctx, req.(*SummationRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _SummationService_CalculateSum_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "summation.proto",
}
